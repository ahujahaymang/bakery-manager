"""
Agent Service - GPT-4o mini fallback.

Drop-in replacement for agent_service_bedrock.py.
Uses OpenAI GPT-4o mini instead of Amazon Bedrock Nova Lite.

To switch: in agent_service.py change the import to use this class.
"""
...
class AgentService:
    """
    GPT-4o mini agent — fallback when Bedrock Nova Lite is too slow.
    Same interface as the Bedrock version.
    """

    def __init__(self, llm_client=None):
        self.llm_client = llm_client or LLMClient()  # OpenAI GPT-4o mini
