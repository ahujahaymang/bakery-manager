...
class WeeklyProfitReport:
    """Data class for weekly profit report."""
    week_start: date
    week_end: date
...
class ReportingService:
    ...
    def calculate_weekly_profit(
        ...
        retrieves all delivered orders within the week, calculates total
        revenue, ingredient costs, packaging costs, and gross profit.
